            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                <div className="brutalist-border bg-brutalist-yellow p-3">
                  <Phone size={24} className="text-brutalist-black" />
                </div>
                <div>
                  <div className="font-black text-lg">CALL US NOW</div>
                  <div className="text-brutalist-yellow text-xl font-bold">+91 98765 43210</div>
                </div>
              </div>

              <div className="flex items-center space-x-4">
                <div className="brutalist-border bg-brutalist-yellow p-3">
                  <Mail size={24} className="text-brutalist-black" />
                </div>
                <div>
                  <div className="font-black text-lg">EMAIL US</div>
                  <div className="text-brutalist-yellow text-xl font-bold">hello@yesfix.in</div>
                </div>
              </div>

              <div className="flex items-center space-x-4">
                <div className="brutalist-border bg-brutalist-yellow p-3">
                  <MapPin size={24} className="text-brutalist-black" />
                </div>
                <div>
                  <div className="font-black text-lg">SERVICE AREAS</div>
                  <div className="text-brutalist-yellow text-xl font-bold">Bangalore • Mumbai • Pune</div>
                </div>
              </div>

              <div className="flex items-center space-x-4">
                <div className="brutalist-border bg-brutalist-yellow p-3">
                  <Clock size={24} className="text-brutalist-black" />
                </div>
                <div>
                  <div className="font-black text-lg">WORKING HOURS</div>
                  <div className="text-brutalist-yellow text-xl font-bold">24/7 Emergency Service</div>
                </div>
              </div>
            </div>
          </div>
